...
VERSION = "0.1.0-rc.1"
DEFAULT_REPOSITORY = "networkgames-hostbridge"
...
RELEASE_PATTERNS = (
    ...
    "*.build.log",
    "networkgames-host-*.digest",
    "networkgames-host-*.oci.index.sha256",
)
    ...
    if existing.returncode == 0:
        ...
        run(
            [
                ...
                "--repo", owner_repo,
                "--prerelease",
                "--title", f"NetworkGames HostBridge {VERSION}",
                "--notes", RELEASE_NOTE,
                *asset_names,
            ],
            cwd=root,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--message", default=f"Build NetworkGames HostBridge {VERSION}")
