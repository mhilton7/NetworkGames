...
printf '{"architecture":"amd64","os":"linux","config":{"User":"568:568","Entrypoint":["/wiibridge-host"],"ExposedPorts":{"8445/tcp":{},"10809/tcp":{}},"Env":["PATH=/"]},"rootfs":{"type":"layers","diff_ids":["sha256:%s"]},"history":[{"created":"2026-07-24T00:00:00Z","created_by":"wiibridge reproducible OCI builder"}]}' "$layer_digest" > "$config_tmp"
