...
| Exact FSInfo TrueNAS deployment | PENDING | Requires a clean published Host image and operator installation on TrueNAS |
| Physical USB Loader GX exact-FSInfo retest | PENDING | Requires the exact-FSInfo Host export followed by Pi reconnect and physical Wii enumeration |
