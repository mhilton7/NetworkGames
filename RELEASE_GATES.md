...
| Large Wii 32 KiB replacement OCI | PASS | Full tests, targeted race tests, static checks, Compose validation, hardened container lifecycle, and OCI inspection pass locally; dirty-worktree candidate digest `sha256:2541660dbf0085b0ccad6f9294ed4446f9ece6aa74ab07efcdb97c4ba71f1789` is not a published release |
| Large Wii 32 KiB TrueNAS deployment | PENDING | Requires a clean published Host image and operator installation on TrueNAS |
| Physical USB Loader GX 32 KiB large-library retest | PENDING | Requires the 32 KiB Host export followed by Pi reconnect and physical Wii enumeration |
