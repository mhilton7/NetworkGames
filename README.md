...
WiiBridge exposes existing WBFS files in place as an immutable,
...
[future hardware acceptance](docs/hardware-acceptance-plan.md). Existing
installations must also follow the [WiiBridge naming migration](docs/wiibridge-rename.md).
