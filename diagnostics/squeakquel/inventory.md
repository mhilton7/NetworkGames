...
- Historical active checkout: `/home/tvos/NetworkGames-zero-w-boot-fix`
...
- Known-working source/backup: commit `f3a2cb2` and
  `/home/tvos/WiiBridge-pre-ethernet-20260725T091858Z`
- Pre-restore archive retained at
  `/home/tvos/networkgames-before-restore-20260726-154457`; SHA-256
...
- Available space at capture: 37 GiB on `/dev/sda1`.
...
- Host: Debian 13, x86_64, kernel `6.12.96+deb13-amd64`.
- Live TrueNAS endpoint: `192.168.0.175`.
...
The Pi was not running: its SD card was attached to this host as `/dev/sdb`,
