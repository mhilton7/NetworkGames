...
`/redacted/local/NetworkGames-zero-w-boot-fix`
...
- Remote: local checkout at
  `/redacted/local/[redacted-uuid]/networkgames-livebridge`
...
- Available space before snapshot creation was approximately 55 GiB on
  `/redacted/local` and 122 GiB on the mounted external project filesystem.

## 3. Safety snapshot

Snapshot directory:

`/redacted/local/networkgames-before-restore-20260726-154457`

Archive:

`/redacted/local/networkgames-before-restore-20260726-154457/NetworkGames-zero-w-boot-fix.tar.xz`
...
`/redacted/local/networkgames-before-restore-20260726-154457/NetworkGames-zero-w-boot-fix-protection-era-tree`

## 4. Backup candidates found

### Selected complete checkout

`/redacted/local/NetworkGames-pre-ethernet-20260725T091858Z`
...
`/redacted/local/NetworkGames-pre-ethernet-20260725T091858Z.bundle`
...
`/redacted/local/Desktop/NetworkGames-safe-backup-2026-07-25`
...
`/redacted/local/NetworkGames-card-backup-pre-bootfix-20260725`
...
`/redacted/local/NetworkGames/networkgames-bridge`
...
- `/redacted/local/networkgames-credentials-server-192.0.2.10-pi-192.0.2.10`
- `/redacted/local/networkgames-card-backups`
- `/redacted/local/NetworkGames-card-backup-pre-bootfix-20260725`
- `/redacted/local/networkgames-usb-trace`
